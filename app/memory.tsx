    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.center}>
                <Brain size={64} color="#A3B8B0" style={{ marginBottom: 20 }} />
                <Text style={styles.title}>Memory Match</Text>
                <Text style={styles.subtitle}>Gentle cognitive recall exercises are currently blossoming. Check back soon.</Text>
            </View>
        </View>
    );
}

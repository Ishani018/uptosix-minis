    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.center}>
                <Sparkles size={64} color="#A3B8B0" style={{ marginBottom: 20 }} />
                <Text style={styles.title}>Zen Garden</Text>
                <Text style={styles.subtitle}>A space to rake sand and arrange stones. Coming soon to your mindful journey.</Text>
            </View>
        </View>
    );
}
